...
// TODO: Re-enable when items and blocks are available
...
public class ItemRegistry {
    ...
    // TODO: Re-enable when CraftComponent and DefaultUpgrade are available
    // protected static final DeferredHolder<Item, ? extends Item>[] COMP_CRAFT_ITEMS = new DeferredHolder[CraftComponent.values().length];
    // protected static final DeferredHolder<Item, ? extends Item>[] UPGRADE_ITEMS = new DeferredHolder[DefaultUpgrade.values().length];

    // TODO: Re-enable items as they become available
    ...
    // TODO: Re-enable when arrays are available
    // public static DeferredHolder<Item, ? extends Item> getComputerCraftItem(int index) {
    //     return COMP_CRAFT_ITEMS[index];
    // }

    // public static DeferredHolder<Item, ? extends Item> getUpgradeItem(int index) {
