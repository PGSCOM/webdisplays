...
public class ScreenConfigData extends GuiData {
	...
	// TODO: NeoForge 21.x - PacketDistributor.TargetPoint eliminated, need to reimplement with new system
	/*
	public void sendTo(PacketDistributor.TargetPoint tp) {
		// TODO: NeoForge 21.x - Reimplement packet sending with IPayloadContext
