...
public abstract class ScreenControl {
	...
	public abstract void handleServer(BlockPos pos, BlockSide side, ScreenBlockEntity tes, IPayloadContext context, Function<Integer, Boolean> permissionChecker) throws MissingPermissionException;
	@OnlyIn(Dist.CLIENT)
	public abstract void handleClient(BlockPos pos, BlockSide side, ScreenBlockEntity tes, IPayloadContext context);
