# Script de migracion de importaciones de Forge a NeoForge
...
Write-Host "Carpeta raiz: $rootPath" -ForegroundColor Yellow
...
foreach ($file in $javaFiles) {
    ...
    if ($content -ne $originalContent) {
        ...
        Write-Host "  OK $($file.Name): $fileReplacements reemplazos" -ForegroundColor Green
    }
}
